...
<body>
	...
	<div class="container">
		...
		<form action="UserControl?action=login" method="post" class="form"
			onsubmit="return validationEmail()">

			<input required class="input" type="text" id="email" name="email"
				placeholder="E-mail" onfocus="myFunction(this)"> <input
				required class="input" type="password" name="password"
				placeholder="Password" onfocus="myFunction(this)"> <span
				class="forgot-password"> <a href="#">Password dimenticata
					?</a>
			</span>
