...
<body>
	<div class="container">
		...
		<form class="form" action="AdminControl?action=registration"
			method="post" onsubmit="return validationEmail()">

			<input class="input" type="email" name="email" placeholder="E-mail"
				required> <input class="input" type="text" name="nome"
				placeholder="Nome" required> <input class="input"
				type="text" name="cognome" placeholder="Cognome" required> <input
				class="input" type="password" name="password" placeholder="Password"
				required> <input class="login-button" type="submit"
				value="Registrati">
