	...
	<table border="1">
		...
		<tbody>
			...
			<tr>
				...
				<td><a
					href="OrderControl?action=viewOrdineCompleto&idFattura=<%= fattura.getIdFattura() %>">Vedi
						dettagli</a><br> <a
					href="OrderControl?action=inviofattura&idFattura=<%= fattura.getIdFattura() %>">Ricevi
						fattura</a></td>
			</tr>
			<% } %>
		</tbody>
